...
#define SHARDER_FILENAME "test.hlsl"
...
void CRenderer::Init()
{
	...
	hr = D3D11CreateDeviceAndSwapChain( NULL,
										D3D_DRIVER_TYPE_HARDWARE, // gpuで処理するのかcpuで処理するかとかの設定
										NULL,
										0,
										NULL,
										0,
	...
	rd.CullMode = D3D11_CULL_BACK; //科リングの設定
...
//
// シェーダーを作成 頂点レイアウトを定義
//HRESULT CRenderer::InitShader()
//{
//	// hlslファイル読み込み
//	// ブロブ(シェーダーの塊。XXシェーダーとして特徴を持たないが後で各シェーダーになりえる)作成
//	ID3DBlob* pCompiledShader = NULL;
//	ID3DBlob* pErrors = NULL;
//	// ブロブからバーテックスシェーダー作成
//	if(FAILED(D3DX11CompileFromFile(SHARDER_FILENAME, NULL, NULL, )))
//}
